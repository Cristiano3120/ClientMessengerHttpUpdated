...
namespace ClientMessengerHttpUpdated
{
    ...
    {
        private static readonly ConcurrentQueue<(string content, ConsoleColor color)> _loggingQueue;
        ...
        {
            AllocConsole();
            _loggingQueue = new ConcurrentQueue<(string content, ConsoleColor color)>();
